...
public class ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator implements com.google.gwt.cell.client.ButtonCellBase.DefaultAppearance.Resources {
  private static ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator _instance0 = new ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator();
  ...
  private void buttonCellBaseStyleInitializer() {
    buttonCellBaseStyle = new com.google.gwt.cell.client.ButtonCellBase.DefaultAppearance.Style() {
      ...
      public String getText() {
        return com.google.gwt.i18n.client.LocaleInfo.getCurrentLocale().isRTL() ? ((".GPBYFDEA{height:" + ((ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getSafeUri().asString() + "\") -" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getLeft() + "px -" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";background-color:" + ("#f1f1f1")  + ";margin:" + ("0")  + ";padding:" + ("5px"+ " " +"7px")  + ";text-decoration:" + ("none")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";font-size:") + (("small")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bbb")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#a0a0a0")  + ";border-radius:" + ("5px")  + ";-moz-border-radius:" + ("5px")  + ";}.GPBYFDEF{background:" + ("#666")  + ";color:" + ("white")  + ";}.GPBYFDEE{background:" + ("#940000")  + ";color:" + ("white")  + ";}.GPBYFDEA:hover{border-color:" + ("#939393")  + ";}.GPBYFDEA[disabled]{cursor:" + ("default") ) + (";color:" + ("#888")  + ";}.GPBYFDEA[disabled]:hover{border-color:" + ("#bbb"+ " " +"#bbb"+ " " +"#a0a0a0")  + ";}.GPBYFDEG{border:" + ("1px"+ " " +"inset"+ " " +"#ccc")  + ";}.GPBYFDEB{border-top-right-radius:" + ("0")  + ";border-bottom-right-radius:" + ("0")  + ";-moz-border-radius-topleft:" + ("0")  + ";-moz-border-radius-bottomleft:" + ("0")  + ";}.GPBYFDEC{border-left:" + ("none")  + ";border-top-left-radius:" + ("0")  + ";border-bottom-left-radius:" + ("0")  + ";-moz-border-radius-topright:") + (("0")  + ";-moz-border-radius-bottomright:" + ("0")  + ";}")) : ((".GPBYFDEA{height:" + ((ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getHeight() + "px")  + ";overflow:" + ("hidden")  + ";background:" + ("url(\"" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getSafeUri().asString() + "\") -" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getLeft() + "px -" + (ButtonCellBase_DefaultAppearance_Resources_default_StaticClientBundleGenerator.this.buttonCellBaseBackground()).getTop() + "px  repeat-x")  + ";height:" + ("auto")  + ";background-color:" + ("#f1f1f1")  + ";margin:" + ("0")  + ";padding:" + ("5px"+ " " +"7px")  + ";text-decoration:" + ("none")  + ";cursor:" + ("pointer")  + ";cursor:" + ("hand")  + ";font-size:") + (("small")  + ";border:" + ("1px"+ " " +"solid"+ " " +"#bbb")  + ";border-bottom:" + ("1px"+ " " +"solid"+ " " +"#a0a0a0")  + ";border-radius:" + ("5px")  + ";-moz-border-radius:" + ("5px")  + ";}.GPBYFDEF{background:" + ("#666")  + ";color:" + ("white")  + ";}.GPBYFDEE{background:" + ("#940000")  + ";color:" + ("white")  + ";}.GPBYFDEA:hover{border-color:" + ("#939393")  + ";}.GPBYFDEA[disabled]{cursor:" + ("default") ) + (";color:" + ("#888")  + ";}.GPBYFDEA[disabled]:hover{border-color:" + ("#bbb"+ " " +"#bbb"+ " " +"#a0a0a0")  + ";}.GPBYFDEG{border:" + ("1px"+ " " +"inset"+ " " +"#ccc")  + ";}.GPBYFDEB{border-top-left-radius:" + ("0")  + ";border-bottom-left-radius:" + ("0")  + ";-moz-border-radius-topleft:" + ("0")  + ";-moz-border-radius-bottomleft:" + ("0")  + ";}.GPBYFDEC{border-right:" + ("none")  + ";border-top-right-radius:" + ("0")  + ";border-bottom-right-radius:" + ("0")  + ";-moz-border-radius-topright:") + (("0")  + ";-moz-border-radius-bottomright:" + ("0")  + ";}"));
      }
  ...
  private static final java.lang.String bundledImage_Horizontal = GWT.getModuleBaseURL() + "B8B1287BEB6352973DF47464D429AEB1.cache.png";
  private static final java.lang.String bundledImage_Horizontal_rtl = GWT.getModuleBaseURL() + "B8B1287BEB6352973DF47464D429AEB1.cache.png";
