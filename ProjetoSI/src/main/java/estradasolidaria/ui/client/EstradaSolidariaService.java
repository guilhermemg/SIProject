...
public interface EstradaSolidariaService extends RemoteService {
	...
	public abstract List<GWTUsuario> pesquisaUsuariosNoSistema(String nome) throws GWTException;

	public abstract List<String> getUsuarioNoSistema(Integer idUsuario) throws GWTException;

	public abstract void deletarInteresse(Integer idSessao, Integer idInteresse) throws GWTException;

	public abstract void encerrarCarona(Integer idSessao, Integer idCaronaEscolhida) throws GWTException;

	public abstract void cancelarCarona(Integer idSessao, Integer idCaronaEscolhida) throws GWTException;
	...
	public abstract List<GWTUsuario> getRankingUsuarios(String ordem) throws GWTException;
	...
	public abstract List<GWTSolicitacao> getSolicitacoesFeitasRejeitadas(Integer idSessao) throws GWTException;

	public abstract List<GWTSolicitacao> getSolicitacoesFeitasCanceladas(Integer idSessao) throws GWTException;
}
